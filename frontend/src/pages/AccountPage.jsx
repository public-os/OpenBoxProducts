...
import { authFetch, clearTokens, saveProfile } from "../utils/auth.js";
    ...
    const loadProfile = async () => {
        try {
            ...
            if (res.ok) {
                ...
                setLoadError(false);
                // DB se jo mila use stored snapshot me bhi rakho (navbar greeting isi se dikhta hai)
                saveProfile(data);
            } else {
                setLoadError(true);
            }
            ...
            <div className="sm:py-15 py-15 min-h-screen bg-gray-400 p-4 sm:p-8 sm:pb-20 pb-20 md:pb-8">
                        ...
                        <div className="flex items-center gap-4 min-w-0">
                            ...
                            <div className="min-w-0">
                                <h2 className="text-base sm:text-lg font-semibold truncate">
                                    {profile ? (profile.name || profile.username) : "Account Details"}
                                </h2>
                                <p className="text-gray-600 truncate">
                                    {profile ? `@${profile.username}` : "Manage your account information"}
                                </p>
                            </div>
                        </div>
                ...
                {avatarOpen && profile && (
                    <AvatarPickerModal
                        ...
                        currentSource={profile.profile_image_source || null}
